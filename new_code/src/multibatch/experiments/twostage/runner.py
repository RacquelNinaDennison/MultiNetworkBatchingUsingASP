...
def _base_row(meta, weight, exposure_n, cfg, threads=1, solver_config="handy") -> dict:
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--weights", type=int, nargs="+", default=[0, 1000])
...
def main() -> None:
    ...
    total_runs = (
        len(instances) * len(args.weights) * len(args.s2_configs)
